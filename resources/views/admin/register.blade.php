...
<div class="container">
    <div class="row justify-content-end">
        <div class="col-md-2">
            <div class="mt-3">
                <a style="color: #666; font-size: 15px; text-decoration: none;" href="{{ url('/admin/login') }}">ログインはこちら</a>
            </div>
        </div>
    </div>
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            <div class="text-center mt-5"> 
                <h1 class="mb-4" style="font-size: 3.0rem; color: #666;">{{ __('新規管理ユーザー登録') }}</h1> 
            </div>
            ...
            <div class="card-body">
                <form method="POST" action="{{ url('admin/register') }}">
                    ...
                    <div class="row mt-5 mb-3">
                        <label for="name" class="col-md-4 col-form-label text-md-end" style="color: #666;">{{ __('ユーザーネーム') }}</label>
                    ...
                    <div class="row mb-3">
                        <label for="name_kana" class="col-md-4 col-form-label text-md-end" style="color: #666;">{{ __('カナ') }}</label>
                    ...
                    <div class="row mb-3">
                        <label for="password-confirm" class="col-md-4 col-form-label text-md-end" style="color: #666;">{{ __('パスワード確認') }}</label>
