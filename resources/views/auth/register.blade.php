...
@section('content')
<div class="container">
<a class="nav-link text-end text-secondary" href="{{ route('login') }}">{{ __('ログインはこちら') }}</a>
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div>
                <div class="row justify-content-center fs-1 text-secondary">{{ __('新規会員登録') }}</div>
                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-0">
                            <div class="col text-center">
                                <button id="register_btn" type="submit" class="btn text-white">
                                    {{ __('登録') }}
                                </button>
                            </div>
                        </div>
