        ...
        <form action="{{ route('user.profile.update') }}" method="POST" enctype="multipart/form-data" class="ProfileForm">
            ...
            <div class="ProfileImageArea">
                <div class="ProfileImageWrapper">
                    <img class="ProfileImg" id="currentProfileImage" src="{{ auth()->user()->profile_image ? asset('storage/' . auth()->user()->profile_image) : asset('images\default.png') }}" alt="プロフィール画像" onerror="this.onerror=null; this.src='{{ asset('images/default.png') }}';">
                </div>
